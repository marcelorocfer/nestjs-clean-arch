...
describe('UserEntity integration tests', () => {
  ...
  describe('Constructor method', () => {
    it('Should throw an error when creating a user with invalid name', async () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        name: null,
      }
    ...
    it('Should throw an error when creating a user with invalid email', async () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        email: null,
      }
    ...
    it('Should throw an error when creating a user with invalid password', async () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        password: null,
      }
    ...
    it('Should throw an error when creating a user with invalid createdAt', async () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
  ...
  describe('Update method', () => {
    ...
    it('Should throw an error when update a user with invalid name', async () => {
  ...
  describe('updatePassword method', () => {
    ...
    it('Should a invalid user password field', async () => {
      const entity = new UserEntity(UserDataBuilder({}));
